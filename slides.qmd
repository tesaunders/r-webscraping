...
`scrape-wikipedia.r` & `scrape-imdb.R`= R scripts to scrape data from IMDb and Wikipedia.
...
1. Set up a [GitHub repository and RStudio project](https://happygitwithr.com/new-github-first).
1. Write an R script to scrape something using [rvest](https://rvest.tidyverse.org/).
1. Create a [GitHub Action](https://rfortherestofus.com/2023/05/github-actions) to automate the scraping based on your chosen frequency.
