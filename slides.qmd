...
::: {.incremental}
1. Application Programming Interfaces (APIs): Software interfaces allowing standardised retrieval of data hosted on a server.
2. Scraping: Extraction of data directly from webpages via code or specialised software.
:::
...
- `scrape-wiki.R`: scrape tables from Wikipedia.
- `scrape-carjam.R`: scrape tables from multiple pages of results.
- `scrape-imdb.R`: scrape table once a week via GitHub Actions.
